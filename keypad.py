def combinationCounts(input1):
    ...
    for letter in letterList:
        totalCount+=findCombinationForAlphabet(letter,n)
...
def findCombinationForAlphabet(letter,n):
    ...
    if(n==1):
        ...
        if(letter=='A'):
            ...
            return findCombinationForAlphabet('D',n-1) + findCombinationForAlphabet('B',n-1) + findCombinationForAlphabet('C',n-1) + findCombinationForAlphabet('F',n-1) + findCombinationForAlphabet('H',n-1)
        elif(letter == 'F'):
